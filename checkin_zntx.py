...
# 登录
def login():
    url = 'http://zntx.cc/waplogin.aspx'
    data = {
        'logname': username,
        'logpass': password,
        'action': 'login',
...
# 签到
def checkin(cookies):
    url = 'http://zntx.cc/Signin/Signin.aspx?Action=index&Mod=Signin&siteid=956'
...
# 登出
def logout(cookies):
    url = 'http://zntx.cc/waplogout.aspx?siteid=956&isGO=OK'
